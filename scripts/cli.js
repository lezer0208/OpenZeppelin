...
const contractABI = require("../artifacts/contracts/Openzeppelinsecure.sol/Openzeppelinsecure.json").abi;

program
    .name("openzeppelinsecure-cli")
    .description("CLI tool for Openzeppelinsecure smart contract")
    .version("1.0.0");
