 ...
 * This file demonstrates how to integrate Openzeppelinsecure with a web frontend
 */

// For React/Vue/Angular applications
export class OpenzeppelinsecureClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OpenzeppelinsecureClient(provider, contractAddress);
